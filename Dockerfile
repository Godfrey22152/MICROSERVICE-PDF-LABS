...
RUN mkdir -p /prod \
 && cp -r app.js routes config models middleware public views node_modules /prod
...
LABEL org.opencontainers.image.title="PDF Labs App" \
      org.opencontainers.image.description="Lightweight and secure Profile-page microservice for PDF Labs" \

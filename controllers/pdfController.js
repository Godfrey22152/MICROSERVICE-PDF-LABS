...
const convertPdfToImage = async (req, res) => {
    ...
    // Format mapping — TIFF intentionally excluded: libtiff has been removed
    // from the container image to eliminate CVE-2023-52356 and CVE-2026-4775.
    const formatMap = {
...
// tiff/tif intentionally removed from extMap — libtiff no longer in image.
const serveLegacyImage = (req, res) => {
    ...
    try {
        ...
        const extMap = { jpeg: "jpg", jpg: "jpg", svg: "svg", eps: "eps", ps: "ps", png: "png" };
